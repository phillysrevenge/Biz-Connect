...
If you believe there may be illegal content hosted on our web services please let us know at Biz-Connect@gmail.com
    </p>
    <p>
        <h2>Terms of use of our web services</h2>
...
<br> You must be at least 13 years old and a human being. <br>
<ul>
    <li>If asked for any personal details, you must answer truthfully (see our privacy policy for what we do with those details). You must supply us with a valid e-mail address.</li>
    <li>You are responsible for the security of your accounts and making sure that any contact details in the account are kept up to date. If we need to contact you but are unable to do so, for example because your e-mail address is no longer valid, then any consequences of that failure will be your responsibility.</li>
    <li>You must not let anyone else use your account. If pressure is applied to you to do so — for example if an employer demands your username and password — please inform them that their attempt to subvert your agreement with us will mean that they have no permission to use any of our services. We may take action, including criminal prosecution, if they use our services using an account they have obtained in this way.</li>
    <li>You must let us know of any unauthorised use of your account as soon as you are able to after becoming aware of it.</li>
    <li>Unless an account is associated with a paid-for service, we may suspend or terminate it at any time. Equally, you may close your account at any time</li>
</ul>
</p>
<p><h2>Community Members</h2>
...
Community membership is not membership in the formal sense of membership of a company limited by guarantee.</p>
<p><h2>Content and intellectual property <br> What we do with your content</h2>
...
<p><h2>liability <br>Indemnities - where you may owe us</h2>
...
<p><h2>Exclusions - What we do not owe you</h2>
...
<p><h2>General conditions <br> This agreement</h2>
...
<h3>Boilerplate</h3>
These final “boilerplate” terms of should go without saying, but we are saying them anyway just to be clear. <br>
If any part of this agreement is ineffective (for example because it is unlawful) then the rest of the agreement should be read without it. <br>
...
<br>
Neither party is liable for anything which is beyond their reasonable control. <br>
If for some reason beyond BizConnect reasonable control, we are unable to or it would not be commercially viable for us to, continue to supply any of our services, we may cease to supply that service, ending any agreement between us for its supply. If we do so, we will return to you a fair proportion of any sum you have paid us in advance for the supply of that service, taking into account the service we have already supplied to you.
</p>
</main>
</body>
<footer class="mt-3">
